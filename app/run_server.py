...
def predict():
	...
	if flask.request.method == "POST":
		...
		logger.info(f'{dt} Data: Glucose={glucose}, BloodPressure={blood_pressure}, Insulin={insulin}, Age={age}')
		try:
			preds = model.predict_proba(pd.DataFrame({"Glucose": [glucose],
